...
simulate_topr = function(n,mug=0.5,Sigma=0,r=10,a=46.55,N=100){
  ...
  result <- list(data=data,StopT=m,W=W,allW=allW,r.index = r.index,sig=n,mug=mug,N=N,r=r,a=a)
  return(result)
}
...
for (i in 1:size){
  ...
  topr = simulate_topr(n=sig,mug=0.5,muw=0.5,Sigma=0,N=N,r=10,a=46.55)

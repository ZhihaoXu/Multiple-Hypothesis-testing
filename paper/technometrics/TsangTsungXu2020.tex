...
\begin{figure}[!htp]
    ...
    %\caption*{(a) Sample Covariance Matrix $\bm \Sigma$}%加*可以去掉默认前缀，作为图片单独的说明 
    \end{minipage} 
    ...
    \end{minipage} 
    \caption{HeatMaps of the Correlation Structure of sample (Left) and adjusted (Right) covariance matrix of the transformed data streams}%n张图片共享的说明 
    \label{cov}
\end{figure} 
...
\bibliographystyle{abbrvnat} % Style BST file
